function fileQueueError(file, errorCode, message){
    try {
        var imageName = window.path+"/img/error.gif";
        var errorName = "";
        ...
        switch (errorCode) {
            case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                imageName = window.path+"/img/zerobyte.gif";
                break;
            case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                imageName = window.path+"/img/toobig.gif";
                break;
            case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
    ...
    try {
        switch (errorCode) {
            ...
            case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
                imageName = window.path+"/img/uploadlimit.gif";
                break;
            default:
                alert(message);
                break;
...
function addImage(src){
    var newElement = "<li><img class='content media-object img-thumbnail'   src='" + src + "' style=\"width:100px;height:100px;\"></li>";
